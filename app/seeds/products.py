...
def seed_products():
    cyberpunk = Product(
        ...
        product_image='https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/cyberpunk2077.jpg'
        )
    cyberpunk2 = Product(
        user_id=1,
        title='CyberPunk64',
        ...
        glitter_factor="Character Customization goes above and beyond and doesnt force default confromity between sexes, everything is customizable, maybe too much is customizable. Nothing holds you back from playing the game your way and there's many storyline npcs you can develope relations with, as expected in the year 2077",
        product_image='https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/cyberpunk64.jpg'
        )
    sims4 = Product(
        user_id=1,
        title='The Sims 4',
        ...
        product_image='https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/sims4.png'
        )
    dragon_age = Product(
        user_id=2,
        ...
        product_image="https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/dragon_age_inquisition1.jpg"
        )
    dad_dating = Product(
        user_id=2,
        ...
        product_image="https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/dream-daddy.jpg"
        )
    life_is_strange = Product(
        ...
        product_image="https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/life-is-strange.jpg"
        )
    hades = Product(
        user_id=1,
        title='Hades',
        ...
        product_image="https://onlyjamsbucket.s3.amazonaws.com/gaymeStop/gayStop-product_images/hades.jpg"
        )
    # title = Product(
    #     user_id=2,
    #     title='',
